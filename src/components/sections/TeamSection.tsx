...
// export default function TeamSection() {
//   return (
//     <section id="team" style={{ backgroundColor: "#fdf6ee", padding: "6rem 1.5rem" }}>
...
//             </p>
//             <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(2.5rem, 5vw, 3.5rem)", fontWeight: 300, color: "#111111", lineHeight: 1.1, marginBottom: "1.5rem" }}>
//               Dr. Nour<br />
//               <em style={{ fontStyle: "italic", color: "#CB8530" }}>Al-Hassan</em>
//             </h2>
...
//                   border: "1px solid rgba(0,0,0,0.12)", padding: "0.25rem 0.75rem",
//                   borderRadius: "9999px", color: "#777777",
//                 }}>{c}</span>
//               ))}
//             </div>

//             <p style={{ color: "#777777", fontSize: "1.25rem", lineHeight: 1.7, marginBottom: "2rem" }}>
//               11 years of specialist experience. 1,452 treatments performed since 2013. Dr. Nour trained at leading institutions in the UK and UAE, and has been a DHA-licensed aesthetic physician for over a decade.
//             </p>

//             <blockquote style={{
//               fontFamily: "var(--font-serif)", fontSize: "1.35rem", fontStyle: "italic",
//               fontWeight: 300, color: "#111111", borderLeft: "2px solid #CB8530",
//               paddingLeft: "1.25rem", marginBottom: "2rem", lineHeight: 1.5,
//             }}>
//               "I became a physician because I believe in the power of looking in the mirror and recognising yourself — just refreshed."
//             </blockquote>
...
//               {badges.map((b) => (
//                 <span key={b} style={{
//                   fontSize: "0.71rem", fontWeight: 500, backgroundColor: "#f2e5d4",
//                   padding: "0.35rem 0.9rem", borderRadius: "0.25rem", color: "#777777",
//                 }}>{b}</span>
//               ))}
//             </div>
...
//           {/* Right — image */}
//           <div style={{ position: "relative", aspectRatio: "3/4", borderRadius: "0.5rem", overflow: "hidden" }}>
//             <Image
//               src="https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=600&h=800&fit=crop&auto=format"
